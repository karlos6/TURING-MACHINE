...
from Automatas.RestaIgualarT import RestaIgualarT
from Automatas.RestaInverso import RestaInverso
from Automatas.RestaSuma import RestaSuma
   ...
   # INICIA EL AUTOMATA
    ...
    def sacarVariables(self):
        ...
        if self.programa[self.cabezal]== '0':            
            ...
            self.RestaIgual = RestaIgualarT(self.programa,self.cabezal,self.v1)
            self.programa = self.RestaIgual.programa
            self.cabezal = self.RestaIgual.cabezal
            self.restaInv = RestaInverso(self.programa,self.cabezal)
